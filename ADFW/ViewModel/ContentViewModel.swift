...
class ContentViewModel: ObservableObject {
    ...
    func fetchData() {
        DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
            ...
            self.cards = [
                CardInfo(imageURL: URL(string: "https://fastly.picsum.photos/id/1003/200/200.jpg?hmac=w2SN03yog7_RB-IfnyWX1FtBjSHebnoWD35Lj4-iV7o")!, title: "Business Areas", description: "Learn more about what ADGM has to offer, from easy set-up processes on an enabling infrastructure to a variety of office spaces.Learn more about what ADGM has to offer, from easy set-up processes on an enabling infrastructure to a variety of office spaces."),
